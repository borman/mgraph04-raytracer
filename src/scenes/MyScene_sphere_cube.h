...
MyScene::MyScene()
{
  ...
  // Small object
  {
    ...
    mat.specularColor = float3(1.0f, 1.0f, 1.0f);
    mat.shininess = 1000;
    mat.reflect = float3(0.9f, 0.9f, 0.9f);
    mat.refract = float3(0.95f, 0.95f, 1.0f);
